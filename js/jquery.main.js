...
/*$(window).scroll(function(){
	($(window).scrollTop() > 400) ? $('.back-to-top').fadeIn(100) : $('.back-to-top').fadeOut(300);
});*/
...
function show_overlay(modalDiv, modalWidth, minHeight) {
		...
		$(modalDiv).modal({
			...
			onShow: function (dialog) {
				...
				$("a.skip-link, .subscribe-link", dialog.data).click(function () {
					...
					$.cookie('emailsignupsmart', true, { expires: 30 });
				});
			},
